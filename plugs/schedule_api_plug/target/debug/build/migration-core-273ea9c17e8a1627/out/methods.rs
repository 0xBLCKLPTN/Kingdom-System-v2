...
//! ➡️  [IntrospectParams](./types/struct.IntrospectParams.html)
//!
//! ↩️  [IntrospectResult](./types/struct.IntrospectResult.html)
//!
...
/// Params type for the introspect method.
#[derive(Serialize, Deserialize, Debug)]
pub struct IntrospectParams {
    ///
    /// JSON name: compositeTypeDepth
